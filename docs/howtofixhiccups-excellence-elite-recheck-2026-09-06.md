...
Date: 2026-09-06 23:41 UTC (updated after `9250a6b` dropped header Privacy a sixteenth time)  
...
PR head at check: `9250a6b44862634e7a23d817663ee3c26cdfe931` (draft)  
...
- **One-line why:** Header Privacy dropped a sixteenth time. FORCE remint is still a plastic-straw blow, not 04. Step clips still MATCH.
...
| Copy | NO | Sixteenth Privacy drop on `/` `/why/` `/when/` `/privacy/` and 404. Footer still has Privacy. Hero plate is still H1+Start only. |
...
| HUMAN excellence copy | FAIL | Body paste still on the page. Locked four-item header is gone a sixteenth time. Hero plate is still H1+Start only. |
...
- Header nav now: The method / Why they start / When to stop. Privacy gone a sixteenth time.
...
Prior wiring elite YES was overridden for step fidelity. The 22:10 pass called YES on live files. Header chrome then flipped thirty-one times. Hero is a 2.5s plastic-straw FORCE remint at 0.45x with H1+Start only. Step clips 01-04 still MATCH. Wired hero, plate, and chrome do not.
