...
Date: 2026-09-06 23:34 UTC (updated after `34a508f` restored header Privacy a fifteenth time)  
...
PR head at check: `34a508f8daa61eb42e4404f37fec00f60d845f22` (draft)  
...
- **One-line why:** Header Privacy is back a fifteenth time; FORCE remint is still a plastic-straw blow, not 04. Do not call YES.
...
| Copy | NO | Header chrome matches again after `34a508f`. Hero plate is still H1+Start only. HUMAN stack still in `band-intro`. Header YES is not a Copy YES. |
...
Prior wiring elite YES was overridden for step fidelity. The 22:10 pass called YES on live files. Header chrome then flipped thirty times. Hero is a 2.5s plastic-straw FORCE remint at 0.45x with H1+Start only. Step clips 01-04 still MATCH. Wired hero and plate do not.
