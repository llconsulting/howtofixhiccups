...
Plain language only. What you collect or do not. No vendor names. No ad theater.
...
We do not receive that sequence.
```
...
If we show ads later, we will update this page.
```
